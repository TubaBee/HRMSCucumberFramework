...
//			System.out.println(row);
		...
		System.out.println("______________rows(0, 2)________________");
	...
	public void i_validate_the_outcomes(DataTable table2) {
		...
		System.out.println("***********  AsList  ***************");
		System.out.println(table2.asList());
		System.out.println("***********  AsLists  ***************");
		...
		System.out.println(table2.asMaps());
		System.out.println("\n \n" );
		List<Map<String, String>> map=table2.asMaps();
	...
	public void i_verify_that_for_value_the_result(Integer value, String result) {
		...
		Assert.assertEquals("Ayni degil yanlis kelime eslesmesi ", result, expected);
	}
}